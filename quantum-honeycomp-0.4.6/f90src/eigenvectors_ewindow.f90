subroutine eigenvectors_ewindow(ndim,matrix,nev_found, &
       evals,evecs,emin,emax,num_offdiagonals)
implicit none
...
!counters
integer :: c1,c2,c3
integer :: num_offdiagonals ! number of offdiagonals
...
ab=0.d00
!do c1=1,ndim
do c1=1,num_offdiagonals + 1 ! number of offdiagonals
  do c2=1,ndim-c1+1
...
call zhbevx('V','V','L',ndim,ldab-1,ab,ldab,q, &
ldq,emin,emax,il,iu,abstol,nev_found,evals,evecs,ldz,work, &
rwork,iwork,ifail,info)

! arrange the eigenvectors in rows
