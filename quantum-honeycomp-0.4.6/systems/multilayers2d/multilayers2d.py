...
def custom_tb90_scf():
  ...
  if scfin == "Ferro": intb90.scf_convergence.mean_field_matrix = "ferro" 
  if scfin == "Antiferro": intb90.scf_convergence.mean_field_matrix = "antiferro" 
  if scfin == "Random": intb90.scf_convergence.mean_field_matrix = "random" 
  if scfin == "Reconverge": intb90.scf_convergence.mean_field_matrix = "from_file" 
  # end SCF options
...
def show_dos(self):
  ...
  intb90.kpoints.nkpoints = int(get("nkpoints")**2)
  s = get("DOS_smearing")
  intb90.dos.smearing_dos = s # smearing of the DOS
  intb90.dos.num_dos = int(2.*6.0/s) # number of DOS steps
  intb90.write() # write input
  os.system("tb90.x")
  os.system("tb90-dos &")
