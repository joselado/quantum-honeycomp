...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.peierls, 3, 1, 1, 1)
        self.kanemele = QtWidgets.QLineEdit(self.tab_3)
        self.kanemele.setObjectName("kanemele")
        self.gridLayout.addWidget(self.kanemele, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.antihaldane, 11, 1, 1, 1)
        ...
        self.interlayer = QtWidgets.QLineEdit(self.tab_3)
        self.interlayer.setObjectName("interlayer")
        ...
        self.bias = QtWidgets.QLineEdit(self.tab_3)
        ...
        self.gridLayout.addWidget(self.antikanemele, 9, 1, 1, 1)
        self.label_41 = QtWidgets.QLabel(self.tab_3)
        self.label_41.setObjectName("label_41")
        self.gridLayout.addWidget(self.label_41, 9, 0, 1, 1)
        ...
        self.gridLayout_36.addWidget(self.label_50, 1, 0, 1, 1)
        self.label_51 = QtWidgets.QLabel(self.tab_6)
        self.label_51.setObjectName("label_51")
        self.gridLayout_36.addWidget(self.label_51, 2, 0, 1, 1)
        self.window_dos = QtWidgets.QLineEdit(self.tab_6)
        self.window_dos.setObjectName("window_dos")
        self.gridLayout_36.addWidget(self.window_dos, 2, 1, 1, 1)
        self.ne_dos = QtWidgets.QLineEdit(self.tab_6)
        self.ne_dos.setObjectName("ne_dos")
        self.gridLayout_36.addWidget(self.ne_dos, 0, 1, 1, 1)
        self.delta_dos = QtWidgets.QLineEdit(self.tab_6)
        self.delta_dos.setObjectName("delta_dos")
        self.gridLayout_36.addWidget(self.delta_dos, 3, 1, 1, 1)
        self.label_48 = QtWidgets.QLabel(self.tab_6)
        self.label_48.setObjectName("label_48")
        self.gridLayout_36.addWidget(self.label_48, 3, 0, 1, 1)
        self.nk_dos = QtWidgets.QLineEdit(self.tab_6)
        self.nk_dos.setObjectName("nk_dos")
        self.gridLayout_36.addWidget(self.nk_dos, 1, 1, 1, 1)
        self.label_49 = QtWidgets.QLabel(self.tab_6)
        self.label_49.setObjectName("label_49")
        self.gridLayout_36.addWidget(self.label_49, 0, 0, 1, 1)
        self.verticalLayout_2.addLayout(self.gridLayout_36)
        self.tabWidget_3.addTab(self.tab_6, "")
        self.tab_14 = QtWidgets.QWidget()
        self.tab_14.setObjectName("tab_14")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.tab_14)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.gridLayout_35 = QtWidgets.QGridLayout()
        self.gridLayout_35.setObjectName("gridLayout_35")
        self.ne_ldos = QtWidgets.QLineEdit(self.tab_14)
        self.ne_ldos.setObjectName("ne_ldos")
        self.gridLayout_35.addWidget(self.ne_ldos, 0, 1, 1, 1)
        self.delta_ldos = QtWidgets.QLineEdit(self.tab_14)
        ...
        self.nk_ldos = QtWidgets.QLineEdit(self.tab_14)
        ...
        self.window_ldos = QtWidgets.QLineEdit(self.tab_14)
        self.window_ldos.setObjectName("window_ldos")
        self.gridLayout_35.addWidget(self.window_ldos, 2, 1, 1, 1)
        self.nsuper_ldos = QtWidgets.QLineEdit(self.tab_14)
        ...
        self.horizontalLayout.addLayout(self.gridLayout_35)
        self.show_interactive_ldos = QtWidgets.QPushButton(self.tab_14)
        self.show_interactive_ldos.setObjectName("show_interactive_ldos")
        self.horizontalLayout.addWidget(self.show_interactive_ldos)
        ...
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tab_16)
        ...
        self.verticalLayout_3.addWidget(self.show_fermi_surface)
        ...
        self.delta_fs = QtWidgets.QLineEdit(self.tab_16)
        self.delta_fs.setObjectName("delta_fs")
        self.gridLayout_37.addWidget(self.delta_fs, 2, 1, 1, 1)
        self.energy_fs = QtWidgets.QLineEdit(self.tab_16)
        ...
        self.nk_fs = QtWidgets.QLineEdit(self.tab_16)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_16.setText(_translate("MainWindow", "Interlayer hopping"))
        self.interlayer.setText(_translate("MainWindow", "0.3"))
        self.label_39.setText(_translate("MainWindow", "Interlayer bias"))
        self.bias.setText(_translate("MainWindow", "0.0"))
        self.antikanemele.setText(_translate("MainWindow", "0.0"))
        self.label_41.setText(_translate("MainWindow", "Anti Kane-Mele"))
        ...
        self.window_dos.setText(_translate("MainWindow", "3.0"))
        self.ne_dos.setText(_translate("MainWindow", "300"))
        self.delta_dos.setText(_translate("MainWindow", "0.1"))
        self.label_48.setText(_translate("MainWindow", "Smearing"))
        self.nk_dos.setText(_translate("MainWindow", "100"))
        self.label_49.setText(_translate("MainWindow", "# of energies"))
        ...
        self.delta_ldos.setText(_translate("MainWindow", "0.1"))
        ...
        self.window_ldos.setText(_translate("MainWindow", "1.0"))
        ...
        self.nk_topology.setText(_translate("MainWindow", "400"))
        ...
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_16), _translate("MainWindow", "Fermi surface"))
        ...
        self.label_8.setText(_translate("MainWindow", "Stacking"))
        self.lattice.setItemText(0, _translate("MainWindow", "A"))
        self.lattice.setItemText(1, _translate("MainWindow", "AA"))
        self.lattice.setItemText(2, _translate("MainWindow", "AB"))
        self.lattice.setItemText(3, _translate("MainWindow", "ABB"))
        self.lattice.setItemText(4, _translate("MainWindow", "ABA"))
        self.lattice.setItemText(5, _translate("MainWindow", "ABC"))
        self.lattice.setItemText(6, _translate("MainWindow", "ABAB"))
        self.lattice.setItemText(7, _translate("MainWindow", "AABB"))
        self.lattice.setItemText(8, _translate("MainWindow", "ABCA"))
        self.lattice.setItemText(9, _translate("MainWindow", "ABBA"))
        self.lattice.setItemText(10, _translate("MainWindow", "ABBB"))
